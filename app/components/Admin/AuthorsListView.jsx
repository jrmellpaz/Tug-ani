...
export default function AuthorsListView() {
    ...
    // w-full gap-6 items-center grid grid-cols-[repeat(auto-fill,_500px] auto-rows-max gap-y-8 justify-center bg-red-400
        ...
        <section className="w-full gap-4 items-center grid grid-cols-[repeat(auto-fill,_400px)] auto-rows-max gap-y-8 justify-center box-border">
            ...
            return <div key={item?.id} className="bg-base-100 h-full flex flex-row gap-4 shadow-xl p-8 rounded-xl items-center max-[600px]:flex-col max-[600px]:w-full  max-[600px]:p-8">
                ...
                <div className="text-tugAni-black w-full h-full">
                    ...
                    <p className="font-openSansRegular text-sm flex flex-row items-center gap-2">
