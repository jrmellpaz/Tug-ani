...
import useAuthorArticles from "@/lib/firebase/article/author_articles";
import ArticleCard from "./ArticleCard";

export function LatestAuthorArticles({ authorId }) {
    const {
        data,
        error,
        isLoading,
        ...
        hasMore,
        fetchArticles
    } = useAuthorArticles(authorId);

    console.log("LatestAuthorArticles data:", data);
